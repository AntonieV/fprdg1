...
"x86_64-linux-thread-multi-4.4.0-96-generic" or
	die "Errno architecture (x86_64-linux-thread-multi-4.4.0-96-generic) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
